...
public class MainActivity extends AppCompatActivity {
    // creating objects for xml attributes
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // setup image
        githubButton.setImageResource(android.R.drawable.ic_menu_search);

        // add click listener to github button, that'll redirect to github website
        githubButton.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/AyeshaZafarDar/QuranAppUsingJson_BITF19M043"));
        ...
        searchByAyahButton.setOnClickListener(v -> {
            ...
            recyclerView.scrollToPosition(ayahNumberInt + 6);
